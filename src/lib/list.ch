...
~take n,l (matchList l (|>_. []) (|>h. |>t. matchBool (eq n 0) [] (cons h (take (n - 1) t))))

# Drop first n elements
~drop n,l (matchList l (|>_. []) (|>h. |>t. matchBool (eq n 0) (cons h t) (drop (n - 1) t)))

# Zip two lists into pairs
~zip a,b (matchList a (|>_. []) (|>ha. |>ta. matchList b (|>_. []) (|>hb. |>tb. cons [ha, hb] (zip ta tb))))
